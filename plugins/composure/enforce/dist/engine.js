...
import { detectLanguage, isTestFile, DEFAULT_SKIP_PATTERNS, } from "./types.js";
/**
 ...
 */
export function validateCode(filePath, content, config) {
 ...
 */
export function frameworkCheck(filePath, content, pluginRoot) {
    const projectRoot = findProjectRoot(filePath);
 ...
 */
export function validateAll(filePath, content, pluginRoot) {
 ...
 */
export function getStack(projectDir) {
