...
// ── Cursor Adapter ──────────────────────────────────────────────
export function adaptCursor(projectDir) {
...
// ── Windsurf Adapter ────────────────────────────────────────────
export function adaptWindsurf(projectDir) {
    ...
    writeFileSync(join(windsurfDir, "hooks.json"), JSON.stringify(hooksConfig, null, 2) + "\n");
...
// ── Cline Adapter ───────────────────────────────────────────────
export function adaptCline(projectDir) {
    const created = [];
    const enforcePath = getEnforcePath();
...
export function adaptGitHooks(projectDir) {
...
export function runAdapter(platform, projectDir) {
