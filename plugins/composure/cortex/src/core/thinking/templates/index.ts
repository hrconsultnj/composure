 ...
 */
export function getTemplate(templateId: string): ThinkingTemplate | null {
 ...
 */
export function listTemplates(): Array<{ id: string; name: string; description: string; steps: number }> {
 ...
 */
export function getNextStep(templateId: string, currentThoughtNumber: number): TemplateStep | null {
