 ...
 */
function isGlobalAgent(agentId: unknown): boolean {
  if (typeof agentId !== "string") return false;
  return agentId === "global" || agentId.startsWith("__");
}

function createAdapter(opts?: { forceGlobal?: boolean }): StorageAdapter {
...
const commands: Record<string, CommandHandler> = {
  ...
  capture_thought: (a, args) => thinking.captureExternalThought(a, args as any),
