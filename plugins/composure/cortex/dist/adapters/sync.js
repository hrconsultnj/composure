 ...
 */
export async function syncUp(local, remote, agentId) {
    const result = {
        direction: "up",
        sessions_synced: 0,
        steps_synced: 0,
 ...
 */
export async function syncDown(local, remote, agentId) {
    const result = {
        direction: "down",
        sessions_synced: 0,
        steps_synced: 0,
 ...
 */
export async function syncStatus(local, remote, agentId) {
    try {
        const localSessions = await local.listSessions(agentId);
        const remoteSessions = await remote.listSessions(agentId);
