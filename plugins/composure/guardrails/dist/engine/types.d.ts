 ...
 */
export type BuiltInConstraint = "no_csam" | "no_bioweapons" | "no_chemical_weapons" | "no_nuclear_weapons" | "no_critical_infrastructure_attacks" | "no_mass_casualty_facilitation" | "no_oversight_undermining";
/**
 * A hard constraint can be a built-in (constitutional) or a custom
 * operator-defined constraint with keyword patterns.
 */
export type HardConstraint = BuiltInConstraint | CustomConstraint;
...
export declare const DEFAULT_BEHAVIORS: RulesetBehaviors;
/**
