 ...
 */
import { getName, getNodeText, getParams, getReturnType, getBases, qualify, getArrowFunctionName, extractImportTarget, resolveModuleToFile, isTestFunction, getCallName, } from "./parser-helpers.js";
// ── JSDoc extraction ──────────────────────────────────────────────
/**
 ...
 */
export function extractJsDocSummary(node) {
 ...
 */
export function heuristicSummary(node, name, params) {
    const parent = node.parent;
    const isExported = parent?.type === "export_statement"
        || (parent?.type === "lexical_declaration" && parent?.parent?.type === "export_statement");
    if (!isExported)
...
// ── Node handlers ─────────────────────────────────────────────────
export function handleClass(walk, child, language, filePath, nodes, edges, enclosingClass, importMap, definedNames, depth) {
...
export function handleType(child, filePath, nodes, edges, enclosingClass, language) {
...
export function handleFunction(walk, child, nodeType, language, filePath, nodes, edges, enclosingClass, importMap, definedNames, depth) {
...
export function handleLexicalDeclaration(walk, child, language, filePath, nodes, edges, enclosingClass, importMap, definedNames, depth) {
...
export function handleImport(child, filePath, edges) {
...
export function handleCall(resolveTarget, child, filePath, enclosingClass, enclosingFunc, importMap, definedNames, edges) {
...
// ── Post-processing ───────────────────────────────────────────────
export function resolveCallTargets(nodes, edges, filePath) {
...
export function generateTestEdges(nodes, edges) {
...
//# sourceMappingURL=parser-handlers.js.map