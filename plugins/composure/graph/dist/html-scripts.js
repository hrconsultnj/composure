 ...
 */
import { CATEGORY_META, jsonInject } from "./html-template.js";
// ── Data constants ────────────────────────────────────────────────
/** Data constants, edge/reverse-dep maps, sizing, state variables. */
export function buildScriptData(nodes, catsPresent, entities) {
    const colorsObj = {};
    const labelsObj = {};
...
export function buildScriptControls() {
    return `
...
export function buildScriptGraphLogic() {
    return `
...
export function buildScriptDetailPanel() {
    return `
...
export function buildScriptTreeView() {
    return `
...
export function buildScriptRender() {
    return `
function render(){
  renderTreeView();
...
export function buildScriptEntityView() {
    return `
...
export function buildScript(nodes, catsPresent, entities) {
    return [
...
//# sourceMappingURL=html-scripts.js.map