---
name: ui-designer
description: Browse and apply premium web design patterns — taxonomy routing, section templates, asset generation, component catalog
...
**Usage**: `/design-forge:ui-designer assets social-media-kit` or `/design-forge:ui-designer assets og-image`
